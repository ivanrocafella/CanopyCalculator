...
public class LoadPrefab : MonoBehaviour
{
    ...
    public void CalculateButtonClick()
    {
        ...
        GameObject ÒountStepColumnInputGB = GameObject.FindGameObjectWithTag("CountStepColumnInput");
        ...
        planCanopy.GetComponent<PlanCanopyGenerator>().CountStep = int.Parse(ÒountStepColumnInputGB.GetComponent<TMP_InputField>().text);
