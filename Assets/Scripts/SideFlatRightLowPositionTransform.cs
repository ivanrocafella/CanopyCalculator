...
public class SideFlatRightLowPositionTransform : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log($"{(float)Math.Floor(columnBody.Height - Math.Tan(planColumn.Slope) * planColumn.SizeByX) / 2}");
    }
