...
public class ShelfTableMountGenerator : MonoBehaviour
{
    ...
    {  
        ...
        Mesh mesh = _3dObjectConstructor.CreatePlate(mountUnitBeamRafterTrussData.LengthFlangeBeamTruss, Canopy.BeamTruss.Truss.ProfileBelt.Height, mountUnitBeamRafterTrussData.ThicknessTable, 0);
